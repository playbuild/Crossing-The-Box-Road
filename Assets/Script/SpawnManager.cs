...
public class SpawnManager : MonoBehaviour
{
    ...
    public GameObject CarSpawn()
    {
        ...
        if(CarCount < 3)           
        {
            GameObject Car1 = Instantiate(Spawn1, transform.position, Quaternion.AngleAxis(180, Vector3.up));
            //GameObject Car1 = ObjectPoolManager.instance.Pool.Get();
            //Car1.transform.position = transform.position;
            //Car1.transform.rotation = Quaternion.AngleAxis(180, Vector3.up);
            //CarCount++;
            return Car1;
        ...
        {
            CarCount = 0;
            return Instantiate(Spawn2, transform.position, Quaternion.AngleAxis(180, Vector3.up));
        }
    }
}
